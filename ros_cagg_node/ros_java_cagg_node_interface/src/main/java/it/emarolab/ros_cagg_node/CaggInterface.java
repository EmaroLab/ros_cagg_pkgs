...
public class CaggInterface {
    ...
    public CaggInterface(String logConfig, String absoluteGrammarPath,
        ...
        TestLog.info( "new CAGG interface with: (logConfig:" + logConfig
    ...
    public ROSResult evaluate(String text) {
        ...
        // evaluate
        TestLog.info("CAGG is testing: \"" + text + "\"");
        ...
        TestLog.info("CAGG end testing. Best solution: \"" + bestResult + "\"");
        return bestResult;
    }
    ...
    class ROSEvaluator extends ThreadedEvaluator {
        ...
        public void activateTrigger(EvaluationResults result) {
            ...
            if (result.getResultOutcome()) {
                ...
                TestLog.info("CAGG found a new Results: " + rosResult);
            }
        }
    }
    ...
    class ROSResult {
        ...
        private float confidence = 0; // in [0,1] = #ofTags/#ofWords
